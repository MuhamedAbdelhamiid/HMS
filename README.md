...
**Project Overview:**
A robust, scalable, and real-time backend API for a Hotel Management System, built with .NET 8 and Clean Architecture. The system manages room bookings, payments, staff task assignments, and features AI-driven content moderation for guest feedback.
...
*   **Performance Optimization (Redis Caching):** Implemented distributed caching using Redis with custom Action Filters to cache frequent GET requests, significantly reducing database load and improving response times.
